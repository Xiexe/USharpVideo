...
#pragma warning disable CS0649
        ...
        public Color greenGraphicColor = new Color(0.19f, 0.632f, 0.19f);
        ...
        public Text[] _subscribedUserListName;
#pragma warning restore CS0649
        ...
        {
            if (powerButtonBackground) powerButtonBackground.color = powerOn ? buttonActivatedColor : buttonBackgroundColor;
            if (powerIcon) powerIcon.color = powerOn ? iconInvertedColor : whiteGraphicColor;
        }

        public void BlinkPowerButton()
        {
            if (powerButtonBackground)
            {
                powerButtonBackground.color = Color.Lerp(buttonBackgroundColor, redGraphicColor, Mathf.PingPong(Time.time, 1));
            }

            if (powerIcon)
            {
                powerIcon.color = Color.Lerp(whiteGraphicColor, iconInvertedColor, Mathf.PingPong(Time.time, 1));
            }
        }
        ...
        {
            targetVideoPlayer.SetSubscribedStatus(!targetVideoPlayer.isSubscribedToPlayer);
        }
