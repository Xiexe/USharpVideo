...
namespace UdonSharp.Video.Internal
{
    ...
    internal class USharpVideoInspector : Editor
    {
        ...
        SerializedProperty defaultPlayerTurnedOn;
        ...
        {
            defaultPlayerTurnedOn = serializedObject.FindProperty(nameof(USharpVideoPlayer.defaultPlayerTurnedOn));
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(defaultPlayerTurnedOn);
